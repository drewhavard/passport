...
class PersonalAccessTokenFactoryTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_access_token_can_be_created()
    {
        ...
        $factory = new DrewHavard\Passport\PersonalAccessTokenFactory($server, $clients, $tokens, $jwt);
        ...
        $this->assertInstanceOf('DrewHavard\Passport\PersonalAccessTokenResult', $result);
    }
}
...
class PersonalAccessTokenFactoryTestModelStub extends DrewHavard\Passport\Token
{
    public $id = 1;
    public $secret = 'something';
}
