...
class TransientTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('DrewHavard\Passport\ApiTokenCookieFactory');
        ...
        $controller = new DrewHavard\Passport\Http\Controllers\TransientTokenController($cookieFactory);
