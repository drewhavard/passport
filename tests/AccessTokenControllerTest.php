...
class AccessTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_a_token_can_be_issued()
    {
        ...
        $tokens = Mockery::mock(DrewHavard\Passport\TokenRepository::class);
        ...
        $controller = new DrewHavard\Passport\Http\Controllers\AccessTokenController($server, $tokens, $jwt);
